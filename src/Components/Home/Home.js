		...
		<div className="container">
			...
			<div className="row">
				<table className="home_table home_table-manager">
					...
					<thead>
						<tr>
							<td className="home_table-column table-column-left">Директор</td>
							<td className="home_table-column">{company.ceo}</td>
						</tr>
						<tr>
							<td className="home_table-column table-column-left"> Главный операционный директор</td>
							<td className="home_table-column">{company.coo}</td>
						</tr>
						<tr>
							<td className="home_table-column table-column-left">Технический директор</td>
							<td className="home_table-column">{company.cto}</td>
						</tr>
						<tr>
							<td className="home_table-column table-column-left">Топ-менеджер</td>
				...
				<table className="home_table home_table-location">
					...
					<thead>
						<tr>
							<td className="home_table-column table-column-left">Штат</td>
							<td className="home_table-column">{company.headquarters.state}</td>
						</tr>
						<tr>
							<td className="home_table-column table-column-left">Город</td>
							<td className="home_table-column">{company.headquarters.city}</td>
						</tr>
						<tr>
							<td className="home_table-column table-column-left">Адрес</td>
